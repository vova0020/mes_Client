...
import styles from './PackageUploadModal.module.css';
...
export const PackageUploadModal: React.FC<PackageUploadModalProps> = ({ onClose }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/package-directory/upload`, {
        method: 'POST',
        body: formData,
      });
