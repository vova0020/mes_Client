...
import { fetchMachinesBySegment, Machine } from '../../../api/masterPage/machineMasterService';
import { machineApi, MachineStatus } from '../../../api/machineApi/machineApi';
import styles from './MachineStatusMenu.module.css';

interface MachineStatusMenuProps {
...
const MachineStatusMenu: React.FC<MachineStatusMenuProps> = ({ anchorEl, open, onClose }) => {
  ...
  const loadMachines = async () => {
    try {
      ...
      console.log('Загруженные станки:', machineList);
...
export default MachineStatusMenu;