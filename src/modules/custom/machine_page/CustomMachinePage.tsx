...
import Sidebar from './components/MachineSidebar/MachineSidebar';

import DetailsTable from './components/MachineDetailsTable/MacinsDetailsTable';
import {
  LoadingSpinner,
  ErrorStatus,
  BrokenStatus,
...
import styles from './CustomMachinePage.module.css';
